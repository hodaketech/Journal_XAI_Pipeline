...
#        print('PlayChess Begin!!')
        ...
        while end is False:
            ...
            self.chesses.pointTurnRight()
                ...
                # Lưu trạng thái bàn cờ sau khi kết thúc ván đấu
        try:
...
def run(n_in_row, width, height, 
    ...
    try:
        ...
        # mcts_player = MCTSPlayer(best_policy.policy_value_fn, c_puct=5, n_playout=n_playout, use_rws=use_rws) # RWS PATCH
        mcts_player = MCTSPlayer(best_policy.policy_value_fn, c_puct=5, n_playout=n_playout, use_rws=use_rws, time_limit=time_limit)
